    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        <Link 
          ...
          className={cn(
            "flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200",
            "bg-gradient-to-br from-primary-custom/80 to-primary-custom text-dark font-medium hover:scale-105",
            location === "/profile" && "ring-2 ring-primary-custom ring-offset-2 ring-offset-dark",
            !isExpanded && "justify-center w-10 h-10 mx-auto"
          )}
