          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <input 
                ...
                className="bg-dark-lighter text-white pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-custom/50 w-full md:w-64"
              />
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400 absolute left-3 top-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            <select className="bg-dark-lighter text-white px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-custom/50 appearance-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-dark-light border-dark-lighter">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Link href="/workflow" className="text-primary-custom text-sm hover:text-primary-custom/80 transition duration-300">
              View All
            </Link>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-dark-light border-dark-lighter">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Link href="/due-diligence" className="text-primary-custom text-sm hover:text-primary-custom/80 transition duration-300">
              View All
            </Link>
          </CardHeader>
          <CardContent>
