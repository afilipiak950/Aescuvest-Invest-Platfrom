...
async function completeFinalDoc() {
  ...
  try {
    console.log(`Processing AI summary for final document ${docId}: ${name}`);
...
Focus on investment-relevant information. Be concise but comprehensive. Only include factual information from the document.`;
    ...
    console.log(`✅ Completed AI summary for final document ${docId} (${name})`);
  ...
  console.log('Final AI summary job completed');
}
