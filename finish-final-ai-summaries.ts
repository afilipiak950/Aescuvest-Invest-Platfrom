    ...
    try {
      ...
      await db.update(backgroundJobs)
        .set({ 
          status: 'processing',
          progress: 75,
          currentStep: 'Generating comprehensive investment analysis...',
          startedAt: new Date()
        })
...
Focus on investment-relevant insights, financial implications, and strategic considerations. Be specific and actionable.`;
      ...
      await db.update(backgroundJobs)
        .set({
          status: 'completed',
          progress: 100,
          currentStep: 'Investment analysis completed',
  ...
  console.log('Final AI summary processing completed');
}

finishFinalAISummaries();