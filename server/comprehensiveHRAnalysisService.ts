...
export class ComprehensiveHRAnalysisService {
    ...
    try {
      ...
      for (let i = 0; i < HR_QUESTIONS.length; i++) {
        ...
        try {
          ...
          // Extract evidence from ALL documents for this question - ENTERPRISE COMPREHENSIVE
  ...
  private async extractEvidenceFromAllDocuments(
    ...
    const evidence = [];
    const batchSize = documents.length > 100 ? 8 : 10; // Optimized batch size for large sets
